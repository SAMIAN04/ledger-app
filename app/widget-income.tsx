// app/widget-income.tsx
//
// Deep-link target for the widget's Income (+) button.
// URL: ledger://widget-income  →  expo-router route /widget-income
//
...
export default function WidgetIncomeGate() {
